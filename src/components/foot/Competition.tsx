...
const Competition = ({ data }: { data: matchesType }) => {
  ...
  return (
    <div className="mb-4 flex  justify-between items-center px-4 py-1 bg-[#F8F3F2] hover:bg-secondary rounded-md">
      <div className="flex space-x-4">
        <Image
          ...
          height={20}
        />
        <p className="text-sm text-[#">{data?.competition.name}</p>
      </div>
